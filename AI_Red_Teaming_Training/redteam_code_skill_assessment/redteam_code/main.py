...
acc = evaluate(model, "./random110_poisoned.csv")
print(f"Model accuracy: {round(acc*100, 2)}%")

message = "Hi, this is Mandy Sullivan calling from HOTMIX FM...you are chosen to receive £5000.00 in our Easter Prize draw.....Please telephone 09041940223 to claim before 29/03/05 or your prize will be transferred to someone else.... Best Regards, HackTheBox" 
